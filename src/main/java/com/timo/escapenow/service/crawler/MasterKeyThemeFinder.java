...
@Slf4j
public class MasterKeyThemeFinder extends ThemeFinder {

    private final String CLASS_NAME_OF_THEME = "box2-inner";
    private final String CLASS_NAME_OF_TITLE = "title";
    ...
    protected List<ThemeInfo> crawlingThemes(Document document) {
        ...
        for (Element element : themeElements) {
            ...
            Elements availableTimeElements = element.getElementsByClass("right").stream()
                    .findFirst()
